...
const NewPost = () => (
  <div className="bg-[#080A0B] text-white rounded-2xl shadow-md p-4 mb-4 border border-white">
    ...
    <div className="flex justify-between items-center mt-2 pl-5 pr-5">
      <div className="flex space-x-4 p-2">
        ...
        <label htmlFor="dropzone-file" className="cursor-pointer">
            <svg className="w-6 h-6  text-blue-500 hover:text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 16 5-7 6 6.5m6.5 2.5L16 13l-4.286 6M14 10h.01M4 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z" /></svg>
            <input id="dropzone-file" type="file" className="hidden" />
          </label>

        <svg className="w-6 h-6  text-blue-500 hover:text-blue-700 cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button className="bg-white text-black rounded-lg px-4 hover:bg-blue-700 hover:text-white cursor-pointer py-2">Đăng</button>
    </div>
  </div>
);

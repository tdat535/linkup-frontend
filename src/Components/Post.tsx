...
const Post = () => {
  return (
    <div className="bg-[#080A0B] text-white rounded-2xl shadow-md p-4 mb-4 border border-white">
      ...
      <svg className="w-6 h-6 hover:text-white cursor-pointer dark:text-white cu" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
